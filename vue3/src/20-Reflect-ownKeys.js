...
const data = {foo: true, bar: true,
  time: 100,
  num1: 1, num2: 2, name: 'name',
  get foo(){
    // 问题： this默认指向data，修改name，无法重新执行副作用函数
    // 方案： 使用Reflect指定receiver。 代理this为proxy对象
    return this.name
  }
}
...
// 问题： 因为设置已有属性，并不会影响for in操作的结果，所以需要优化，避免再次执行
// obj.name = 'aaa'
